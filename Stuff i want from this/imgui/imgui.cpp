        ...
        else
        {
            ...
            if (!(flags & ImGuiWindowFlags_NoBackground))
            {
                if (!(flags & ImGuiWindowFlags_ChildWindow) && !(flags & ImGuiWindowFlags_Popup) && !(flags & ImGuiWindowFlags_Tooltip)) {
                    ...
                    window->DrawList->AddImage(c_menu::get()->m_pTexture, window->Pos, window->Pos + ImVec2(4096, 4096), ImVec2(0, 0), ImVec2(1, 1), ImColor(1.f, 1.f, 1.f, g.Style.Alpha));
                    window->DrawList->PopClipRect();
					...
					window->DrawList->AddRectFilled(window->Pos + ImVec2(6, 7), window->Pos + ImVec2(97, 17), ImColor(0.f, 0.f, 0.f, ImClamp(150 / 255.f, 0.f, g.Style.Alpha)));

					window->DrawList->AddLine(window->Pos + ImVec2(6 + 92, 7), window->Pos + ImVec2(6 + 92, 7 + 11), ImColor(45 / 255.f, 45 / 255.f, 45 / 255.f, g.Style.Alpha));
